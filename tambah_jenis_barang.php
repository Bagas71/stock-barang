    ...
    if (tambah_jenisBarang($_POST) > 0) {
        ...
        echo "
            <script>
                ...
                document.location.href = 'tambah_jenis_barang.php';
            </script>
            ";
    }
}
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="jenis"  class="form-control" id="jenis" placeholder="Masukkan Jenis Barang...">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button type="submit" name="tambahJenis"  class="btn btn-success">Tambah</button>
                                </div>
                            </div>
                        </form>
                        </div>
