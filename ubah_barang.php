    ...
    if(ubahBarang($_POST) > 0 ){
        ...
        echo "
            <script>
                ...
                document.location.href = 'ubah_barang.php?id=$id';
            </script>
            ";
                        ...
                        <div class="position-center">
                          ...
                          <div class="form-group">
                                <label for="jenis" class="col-lg-2 col-sm-2 control-label" style="text-align: justify;">Jenis Barang</label>
                                 <div class="col-lg-10">
                                    <select id="jenis" required class="form-control m-bot15" name="jenis"  required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <img src="img/<?= $ubahBarang["gambar"]; ?>" width="50">
